...
(function (F05325) {
        ...
        Object.defineProperty(UpdateRules.prototype, "ResetDataTables", {
            get: function () {
                if (this._resetDataTables == null) {
                    this._resetDataTables = [this.Document.P3DataTable];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "RecalcedDataTables", {
            get: function () {
                if (this._recalcedDataTables == null) {
                    this._recalcedDataTables = [this.Document.P4DataTable, this.Document.P5DataTable];
                }
            ...
            get: function () {
                if (this._shiftYearTables == null) {
                    this._shiftYearTables = [
                        ...
                        {
                            Table: this.Document.P3DataTable,
                            GenericFields: [BaseObasTableFields.YearDataField, BaseObasTableFields.CountYearDataField, F05325.P3DataTable.PayField]
                        }
                    ];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "CopyDataTables", {
            get: function () {
                if (this._copyDataTables == null) {
                    this._copyDataTables = [this.Document.P1TotalTable, this.Document.P4DataTable, this.Document.P5DataTable];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "DeleteYearTables", {
            get: function () {
                if (this._deleteYearTables == null) {
                    this._deleteYearTables = [this.Document.P4DataTable, this.Document.P5DataTable];
                }
    ...
    F05325.UpdateRules = UpdateRules;
})(F05325 || (F05325 = {}));
