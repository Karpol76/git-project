...
(function (F05401) {
        ...
        Object.defineProperty(UpdateRules.prototype, "RecalcedDataTables", {
            get: function () {
                if (this._recalcedDataTables == null) {
                    this._recalcedDataTables = [this.Document.P1TotalTable, this.Document.P2Table];
                }
            ...
            get: function () {
                if (this._shiftYearTables == null) {
                    this._shiftYearTables = [
                        ...
                        {
                            Table: this.Document.P2Table,
                            GenericFields: [BaseObasTableFields.YearDataField, F05401.P2Table.CompetitiveYearDataField, F05401.P2Table.PopulationYearDataField]
                        }
                    ];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "CopyDataTables", {
            get: function () {
                if (this._copyDataTables == null) {
                    this._copyDataTables = [this.Document.P1TotalTable, this.Document.P2Table];
                }
    ...
    F05401.UpdateRules = UpdateRules;
})(F05401 || (F05401 = {}));
