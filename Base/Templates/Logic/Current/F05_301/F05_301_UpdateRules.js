...
(function (F05301) {
            ...
            get: function () {
                if (this._shiftYearTables == null) {
                    this._shiftYearTables = [
                        ...
                        {
                            Table: this.Document.TableP4,
                            GenericFields: [F05301.P4Table.QuantityField, BaseObasTableFields.YearDataField]
                        }
                    ];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "CopyDataTables", {
            get: function () {
                if (this._copyDataTables == null) {
                    this._copyDataTables = [this.Document.TableP3, this.Document.TableP4];
                }
    ...
    F05301.UpdateRules = UpdateRules;
})(F05301 || (F05301 = {}));
