...
(function (F08100) {
        ...
        Object.defineProperty(UpdateRules.prototype, "RecalcedDataTables", {
            get: function () {
                if (this._recalcedDataTables == null) {
                    this._recalcedDataTables = [this.Document.TableP2, this.Document.TableP3, this.Document.TableP4, this.Document.TableP5];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "CopyDataTables", {
            get: function () {
                if (this._copyDataTables == null) {
                    this._copyDataTables = [this.Document.TableP2, this.Document.TableP3, this.Document.TableP4, this.Document.TableP5];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "DeleteYearTables", {
            get: function () {
                if (this._deleteYearTables == null) {
                    this._deleteYearTables = [this.Document.TableP2, this.Document.TableP3, this.Document.TableP4];
                }
    ...
    F08100.UpdateRules = UpdateRules;
})(F08100 || (F08100 = {}));
