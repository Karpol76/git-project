...
(function (F05307) {
    ...
    F05307.InterfaceRules = InterfaceRules;
    var P4GroupSheet = (function (_super) {
        ...
        P4GroupSheet.prototype.GetCaptionEventHandler = function (sheetId, index, defaultCaption, fieldCaption) {
            var columnIndex = 3 + ObasHelper.GetYearOffsetById(sheetId);
            return "\u0421\u0443\u043C\u043C\u0430, \u0440\u0443\u0431\n((\u0433\u0440. 3 * \u0433\u0440. " + columnIndex + " \u0440\u0430\u0437\u0434. 3 (01) + \u0433\u0440. 4 * \u0433\u0440. " + columnIndex + " \u0440\u0430\u0437\u0434. 3 (02)  + \u0433\u0440. 5 * \u0433\u0440. " + columnIndex + " \u0440\u0430\u0437\u0434. 3 (03) * 12) * (1 + \u0433\u0440. 6 / 100))";
        };
    ...
    F05307.P4GroupSheet = P4GroupSheet;
})(F05307 || (F05307 = {}));
