...
(function (F05310) {
    var FDocument = (function (_super) {
        ...
        function FDocument(id, version, oldVersion) {
            ...
            _this._sheetP3 = null;
            _this._sheetP4 = null;
            _this._tableRules = new F05310.TableRules(_this);
            _this._interfaceRules = new F05310.InterfaceRules(_this);
            _this._updateRules = new F05310.UpdateRules(_this);
            _this._exportRules = new F05310.ExportRules(_this);
            return _this;
        }
        ...
        Object.defineProperty(FDocument.prototype, "RegionsTable", {
            get: function () {
                if (this._regionsTable == null) {
                    this._regionsTable = new F05310.RegionsTable("F05_310_Regions", this);
                }
        ...
        Object.defineProperty(FDocument.prototype, "TableP1", {
            get: function () {
                if (this._tableP1 == null) {
                    this._tableP1 = new SubsidiesSubventions.P1TotalTable("F05_310_R1_SumValues", this);
                }
        ...
        Object.defineProperty(FDocument.prototype, "TableP2", {
            get: function () {
                if (this._tableP2 == null) {
                    this._tableP2 = new YearTransposedObasTable("tF05_310_R4", ["OwnerKey"]);
                }
        ...
        Object.defineProperty(FDocument.prototype, "TableP3", {
            get: function () {
                if (this._tableP3 == null) {
                    this._tableP3 = new F05310.P3Table("F05_310_R3_Values", this);
                }
        ...
        Object.defineProperty(FDocument.prototype, "TableP4", {
            get: function () {
                if (this._tableP4 == null) {
                    this._tableP4 = new F05310.P4Table("F05_310_R4", this, this.TableP3, this.RegionsTable);
                }
        ...
        Object.defineProperty(FDocument.prototype, "SheetP4", {
            get: function () {
                if (this._sheetP4 == null) {
                    this._sheetP4 = new F05310.P4GroupSheet(this, new SubsidiesSubventions
                        .FSheetOptions(1, SheetFormatCollection.Spr, SheetFormatCollection.Free, SheetFormatCollection.Default), this.RegionsTable, new SubsidiesSubventions.EditorsSubjects("F05_310_R4_Subject_Editor", "F05_310_R4_ScienceCityName_Editor", "F05_310_R4_SecurityAdmTerrEntityName_Editor", "F05_310_R4_MunicipalEntityName_Editor"));
                }
