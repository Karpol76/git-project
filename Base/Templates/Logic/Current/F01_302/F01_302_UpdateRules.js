...
(function (F01302) {
            ...
            get: function () {
                if (this._recalcedDataTables == null) {
                    this._recalcedDataTables = [
                        ...
                        this.Document.P2Sp2DataTable,
                        this.Document.P2Sp3DataTable,
                        this.Document.P3Sp1Table,
                        this.Document.P3Sp2DataTable,
                        this.Document.P3Sp3DataTable,
                        this.Document.P4Sp1Table
                    ];
                }
            ...
            get: function () {
                if (this._shiftYearTables == null) {
                    this._shiftYearTables = [
                        ...
                        {
                            Table: this.Document.P2Sp1Table,
                            GenericFields: [BaseObasTableFields.YearDataField]
                        },
                        {
                            Table: this.Document.P3Sp1Table,
                            GenericFields: [BaseObasTableFields.YearDataField]
                        },
                        {
                            Table: this.Document.P4Sp1Table,
                            GenericFields: [BaseObasTableFields.YearDataField]
                        }
                    ];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "DeleteYearTables", {
            get: function () {
                if (this._deleteYearTables == null) {
                    this._deleteYearTables = [this.Document.P2Sp2DataTable, this.Document.P2Sp3DataTable, this.Document.P3Sp2DataTable];
                }
    ...
    F01302.UpdateRules = UpdateRules;
})(F01302 || (F01302 = {}));
