...
(function (F02110) {
            ...
            get: function () {
                if (this._recalcedDataTables == null) {
                    this._recalcedDataTables = [
                        this.Document.Ref1ObjTable,
                        this.Document.Ref2ObjTable
                    ];
                }
            ...
            get: function () {
                if (this._shiftYearTables == null) {
                    this._shiftYearTables = [
                        ...
                        {
                            Table: this.Document.Ref2ObjTable,
                            GenericFields: [
                                BaseObasTableFields.YearDataField,
                                BaseObasTableFields.UsdYearDataField,
                                BaseObasTableFields.RubYearDataField,
                                F02110.ObasTableFields.OtherRubField
                            ]
                        }
                    ];
                }
    ...
    F02110.UpdateRules = UpdateRules;
})(F02110 || (F02110 = {}));
