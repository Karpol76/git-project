...
(function (F08821) {
    var UpdateRules = (function (_super) {
        ...
        Object.defineProperty(UpdateRules.prototype, "RecalcedDataTables", {
            get: function () {
                if (this._recalcedDataTables == null) {
                    this._recalcedDataTables = [this.Document.P1Table, this.Document.P2DataTable];
                }
            ...
            get: function () {
                if (this._shiftYearTables == null) {
                    this._shiftYearTables = [
                        ...
                        {
                            Table: this.Document.P2DataTable,
                            GenericFields: [BaseObasTableFields.UsdYearDataField, BaseObasTableFields.YearDataField]
                        }
                    ];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "CopyDataTables", {
            get: function () {
                if (this._copyDataTables == null) {
                    this._copyDataTables = [this.Document.P1Table, this.Document.P2DataTable];
                }
        ...
        UpdateRules.prototype.InnerUpdate = function (oldVersion, currentVersion) {
            if (this.CanUpdateTo("1.0.2")) {
                this.Document.P1Table.DeleteUnlinkData();
                this.RecalcData();
            }
        };
        return UpdateRules;
    }(BaseUpdateRules));
    F08821.UpdateRules = UpdateRules;
})(F08821 || (F08821 = {}));
