...
(function (F03320) {
    var FDocument = (function (_super) {
        ...
        function FDocument(id, version, oldVersion) {
            ...
            _this._tableRules = new F03320.TableRules(_this);
            _this._interfaceRules = new F03320.InterfaceRules(_this);
            _this._updateRules = new F03320.UpdateRules(_this);
            _this._exportRules = new F03320.ExportRules(_this);
            return _this;
        }
        ...
        Object.defineProperty(FDocument.prototype, "SubjectDataTable", {
            get: function () {
                if (this._subjectDataTable == null) {
                    this._subjectDataTable = new F03320.SubjectDataTable("F03_320_R2_SN", this.RecipientDataTable, this.TotalTable);
                }
        ...
        Object.defineProperty(FDocument.prototype, "RecipientDataTable", {
            get: function () {
                if (this._recipientDataTable == null) {
                    this._recipientDataTable = new F03320.RecipientsDataTable("F03_320_R2_RC", this.PnoDataTable, this.P1TotalTable);
                }
        ...
        Object.defineProperty(FDocument.prototype, "PnoDataTable", {
            get: function () {
                if (this._pnoDataTable == null) {
                    this._pnoDataTable = new F03320.PnoDataTable("F03_320_R2_PC", this);
                }
        ...
        Object.defineProperty(FDocument.prototype, "P1TotalTable", {
            get: function () {
                if (this._p1TotalTable == null) {
                    this._p1TotalTable = new F03320.P1TotalTable("F03_320_R1_Values", this);
                }
        ...
        Object.defineProperty(FDocument.prototype, "P2SheetSp1", {
            get: function () {
                if (this._p2SheetSp1 == null) {
                    this._p2SheetSp1 = new F03320.P2GroupSheetSp1(this);
                }
        ...
        Object.defineProperty(FDocument.prototype, "P2SheetSp2", {
            get: function () {
                if (this._p2SheetSp2 == null) {
                    this._p2SheetSp2 = new F03320.P2GroupSheetSp2(this);
                }
