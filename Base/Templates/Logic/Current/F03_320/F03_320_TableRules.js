...
(function (F03320) {
    ...
    F03320.TableRules = TableRules;
    var StrKeysP1Total;
    (function (StrKeysP1Total) {
        StrKeysP1Total[StrKeysP1Total["Total"] = 1] = "Total";
    })(StrKeysP1Total = F03320.StrKeysP1Total || (F03320.StrKeysP1Total = {}));
    ...
    F03320.P1TotalTable = P1TotalTable;
    ...
    F03320.ObasTablePnoYearKeys = ObasTablePnoYearKeys;
    ...
    F03320.PnoDataTable = PnoDataTable;
    ...
    F03320.ObasTablePnoRecipientYearKeys = ObasTablePnoRecipientYearKeys;
    ...
    F03320.RecipientsDataTable = RecipientsDataTable;
    ...
    F03320.ObasTablePnoRecipientYearSubjectKeys = ObasTablePnoRecipientYearSubjectKeys;
    var SubjectDataTable = (function (_super) {
        ...
        function SubjectDataTable(id, parentTable, _sumTable) {
            ...
            _this._copyData = null;
            _this._copyFields = null;
            _this._sumGroupAvg = null;
            _this._sumGroupPO = null;
            return _this;
        }
        ...
        Object.defineProperty(SubjectDataTable.prototype, "SumGroupPO", {
            get: function () {
                var _this = this;
                if (this._sumGroupPO == null) {
                    this._sumGroupPO = new CalcFields(this.g9, this.g5, this.g8, this, function (tableId, oldValue, newValue, fieldId) { _this.SumG5TotalChangeEventHandler(tableId, oldValue, newValue, fieldId); });
                }
                return this._sumGroupPO;
            },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(SubjectDataTable.prototype, "SumGroupAvg", {
            get: function () {
                if (this._sumGroupAvg == null) {
                    this._sumGroupAvg = new CalcFields(this.g8, this.g6, this.g7, this, null);
                }
                return this._sumGroupAvg;
            },
            enumerable: true,
            configurable: true
        });
        SubjectDataTable.prototype.SumG9G10ChangeEventHandler = function (tableId, oldValue, newValue, fieldId) {
            this.g11.Value = this.g9.Value + this.g10.Value;
            if (this.g9.Id === fieldId) {
                this.ParentTable.SetSumByKeys(this.ParentTable.g5.Id, this.ParentTable.GetKeys(this.Pno.ForeignKey.Value, this.Year.Value, this.Recipient.ForeignKey.Value), oldValue, this.g9.NValue);
            }
            if (this.g10.Id === fieldId) {
                this.ParentTable.SetSumByKeys(this.ParentTable.g6.Id, this.ParentTable.GetKeys(this.Pno.ForeignKey.Value, this.Year.Value, this.Recipient.ForeignKey.Value), oldValue, this.g10.NValue);
            }
        };
        ...
        SubjectDataTable.prototype.InnerCopyData = function (recordKey, endYear) {
            if (this.Locate(this.RecordKey.Id, recordKey)) {
                ...
                for (var year = keys.Year + 1; year <= endYear; year++) {
                    ...
                    copyData.getValue(this.OwnerKey.Id).Value = ownerKey;
                    keys.Year = year;
                    this.SetupTableRecordData(copyData, this.RecordKey.LookupByKeys(keys.ToArray()));
                }
                this.Locate(this.RecordKey.Id, recordKey);
            }
        };
    ...
    F03320.SubjectDataTable = SubjectDataTable;
})(F03320 || (F03320 = {}));
