...
(function (F02242) {
    var UpdateRules = (function (_super) {
        ...
        Object.defineProperty(UpdateRules.prototype, "RecalcedDataTables", {
            get: function () {
                if (this._recalcedDataTables == null) {
                    this._recalcedDataTables = [this.Document.Ref1ObjTable];
                }
            ...
            get: function () {
                if (this._shiftYearTables == null) {
                    this._shiftYearTables = [
                        ...
                        {
                            Table: this.Document.P2OkpdTable,
                            GenericFields: [BaseObasTableFields.YearDataField]
                        },
                        {
                            Table: this.Document.Ref1ObjTable,
                            GenericFields: [BaseObasTableFields.YearDataField, F02242.ObasTableFields.Part1Field, F02242.ObasTableFields.Part3Field]
                        }
                    ];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "CopyDataTables", {
            get: function () {
                if (this._copyDataTables == null) {
                    this._copyDataTables = [this.Document.Ref1ObjTable];
                }
        ...
        UpdateRules.prototype.InnerUpdate = function (oldVersion, currentVersion) {
            if (this.CanUpdateTo("1.0.7")) {
                this.RecalcData();
            }
        };
        return UpdateRules;
    }(BaseUpdateRules));
    F02242.UpdateRules = UpdateRules;
})(F02242 || (F02242 = {}));
