...
(function (F03220) {
    ...
    F03220.P1TotalTable = P1TotalTable;
    ...
    F03220.ObasTablePnoYearKeys = ObasTablePnoYearKeys;
    ...
    F03220.PnoDataTable = PnoDataTable;
    ...
    F03220.ObasTablePnoRecipientYearKeys = ObasTablePnoRecipientYearKeys;
    var RecipientsDataTable = (function (_super) {
        ...
        function RecipientsDataTable(id, parentTable, _sumTable) {
            ...
            _this._pnoKey = null;
            _this._averegaPay = null;
            _this._averageArea = null;
            _this._copyFields = null;
            return _this;
        }
        Object.defineProperty(RecipientsDataTable.prototype, "AverageArea", {
            get: function () {
                if (this._averageArea == null) {
                    this._averageArea = new NumberObasTableField("g5", this);
                }
        ...
        Object.defineProperty(RecipientsDataTable.prototype, "AveregaPay", {
            get: function () {
                if (this._averegaPay == null) {
                    this._averegaPay = new NumberObasTableField("g4", this);
                }
                return this._averegaPay;
            },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(RecipientsDataTable.prototype, "TotalObas", {
            get: function () {
                if (this._totalObas == null) {
                    this._totalObas = new NumberObasTableField("g9", this);
                }
        ...
        Object.defineProperty(RecipientsDataTable.prototype, "AddObas", {
            get: function () {
                if (this._addObas == null) {
                    this._addObas = new NumberObasTableField("g8", this);
                }
        ...
        Object.defineProperty(RecipientsDataTable.prototype, "Obas", {
            get: function () {
                if (this._obas == null) {
                    this._obas = new NumberObasTableField("g7", this);
                }
                return this._obas;
            },
            enumerable: true,
        ...
        Object.defineProperty(RecipientsDataTable.prototype, "Pay", {
            get: function () {
                if (this._pay == null) {
                    this._pay = new NumberObasTableField("g6", this);
                }
                return this._pay;
            },
            enumerable: true,
        ...
        RecipientsDataTable.prototype.PayPartsChangeEventHandler = function (tableId, oldValue, newValue, fieldId) {
            this.Pay.Value = this.AveregaPay.NValue * this.AverageArea.NValue;
        };
        ...
        RecipientsDataTable.prototype.ResetData = function (keys) {
            ...
            var resetHandler = function () {
                ...
                _this.AveregaPay.Value = 0;
                _this.AverageArea.Value = 0;
                _this.Pay.Value = 0;
                _this.Obas.Value = 0;
    ...
    F03220.RecipientsDataTable = RecipientsDataTable;
})(F03220 || (F03220 = {}));
