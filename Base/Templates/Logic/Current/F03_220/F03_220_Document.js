...
(function (F03220) {
    var FDocument = (function (_super) {
        ...
        function FDocument(id, version, oldVersion) {
            ...
            _this._tableRules = new F03220.TableRules(_this);
            _this._interfaceRules = new F03220.InterfaceRules(_this);
            _this._updateRules = new F03220.UpdateRules(_this);
            _this._exportRules = new F03220.ExportRules(_this);
            return _this;
        }
        ...
        Object.defineProperty(FDocument.prototype, "P1Sheet", {
            get: function () {
                if (this._p1Sheet == null) {
                    this._p1Sheet = new F03220.P1Sheet("SHT_F03_220_R1", this);
                }
        ...
        Object.defineProperty(FDocument.prototype, "P2GroupSheet", {
            get: function () {
                if (this._p2GroupSheet == null) {
                    this._p2GroupSheet = new F03220.P2GroupSheet(this);
                }
        ...
        Object.defineProperty(FDocument.prototype, "P1TotalTable", {
            get: function () {
                if (this._p1TotalTable == null) {
                    this._p1TotalTable = new F03220.P1TotalTable("F03_220_R1_SumValues", this);
                }
        ...
        Object.defineProperty(FDocument.prototype, "PnoDataTable", {
            get: function () {
                if (this._pnoDataTable == null) {
                    this._pnoDataTable = new F03220.PnoDataTable("F03_220_R2_PC_V3", this);
                }
        ...
        Object.defineProperty(FDocument.prototype, "RecipientDataTable", {
            get: function () {
                if (this._recipientDataTable == null) {
                    this._recipientDataTable = new F03220.RecipientsDataTable("F03_220_R2_CR_V2", this.PnoDataTable, this.P1TotalTable);
                }
