...
(function (F05320) {
        ...
        Object.defineProperty(UpdateRules.prototype, "ResetDataTables", {
            get: function () {
                if (this._resetDataTables == null) {
                    this._resetDataTables = [this.Document.SubjectsDataTable];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "RecalcedDataTables", {
            get: function () {
                if (this._recalcedDataTables == null) {
                    this._recalcedDataTables = [this.Document.P3Sp1DataTable, this.Document.P3Sp2DataTable, this.Document.P4Sp1DataTable,
                        this.Document.P4Sp2DataTable, this.Document.P5DataTable];
                }
            ...
            get: function () {
                if (this._shiftYearTables == null) {
                    this._shiftYearTables = [
                        ...
                        {
                            Table: this.Document.P3Sp1DataTable,
                            GenericFields: this.Document.P3Sp1DataTable.ResetFields()
                        },
                        {
                            Table: this.Document.P3Sp2DataTable,
                            GenericFields: this.Document.P3Sp2DataTable.ResetFields()
                        },
                        {
                            Table: this.Document.P4Sp1DataTable,
                            GenericFields: this.Document.P4Sp1DataTable.ResetFields()
                        },
                        {
                            Table: this.Document.P4Sp2DataTable,
                            GenericFields: this.Document.P4Sp2DataTable.ResetFields()
                        }
                    ];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "CopyDataTables", {
            get: function () {
                if (this._copyDataTables == null) {
                    this._copyDataTables = [this.Document.P1TotalTable,
                        this.Document.P3Sp1DataTable, this.Document.P3Sp2DataTable, this.Document.P4Sp1DataTable,
                        this.Document.P4Sp2DataTable, this.Document.P5DataTable];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "DeleteYearTables", {
            get: function () {
                if (this._deleteYearTables == null) {
                    this._deleteYearTables = [this.Document.P5DataTable];
                }
    ...
    F05320.UpdateRules = UpdateRules;
})(F05320 || (F05320 = {}));
