...
(function (F08910) {
    var FDocument = (function (_super) {
        ...
        function FDocument(id, version, oldVersion) {
            ...
            _this._p1Table = null;
            _this._tableRules = new F08910.TableRules(_this);
            _this._interfaceRules = new F08910.InterfaceRules(_this);
            _this._updateRules = new F08910.UpdateRules(_this);
            _this._exportRules = new F08910.ExportRules(_this);
            return _this;
        }
        ...
        Object.defineProperty(FDocument.prototype, "P1Table", {
            get: function () {
                if (this._p1Table == null) {
                    this._p1Table = new F08910.P1Table("F08_910_R1", this.P1TotalTable);
                }
        ...
        Object.defineProperty(FDocument.prototype, "P1TotalTable", {
            get: function () {
                if (this._p1TotalTable == null) {
                    this._p1TotalTable = new F08910.P1TotalTable("F08_910_R1_Total", this);
                }
        ...
        Object.defineProperty(FDocument.prototype, "P1Sheet", {
            get: function () {
                if (this._p1Sheet == null) {
                    this._p1Sheet = new F08910.P1Sheet("SHT_F08_910_R1", this);
                }
