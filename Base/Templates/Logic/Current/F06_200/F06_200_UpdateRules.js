...
(function (F06200) {
        ...
        Object.defineProperty(UpdateRules.prototype, "RecalcedDataTables", {
            get: function () {
                if (this._recalcedDataTables == null) {
                    this._recalcedDataTables = [this.Document.TableP2Sp1, this.Document.TableP3Sp1Values, this.Document.TableP4Sp1];
                }
            ...
            get: function () {
                if (this._shiftYearTables == null) {
                    this._shiftYearTables = [
                        ...
                        {
                            Table: this.Document.TableP4Sp1,
                            GenericFields: [BaseObasTableFields.YearDataField]
                        }
                    ];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "CopyDataTables", {
            get: function () {
                if (this._copyDataTables == null) {
                    this._copyDataTables = [this.Document.TableP2Sp1, this.Document.TableP3Sp1Values, this.Document.TableP4Sp1];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "DeleteYearTables", {
            get: function () {
                if (this._deleteYearTables == null) {
                    this._deleteYearTables = [this.Document.TableP2Sp1, this.Document.TableP3Sp1Values];
                }
    ...
    F06200.UpdateRules = UpdateRules;
})(F06200 || (F06200 = {}));
