...
(function (F01285) {
            ...
            get: function () {
                if (this._recalcedDataTables == null) {
                    this._recalcedDataTables = [
                        this.Document.P2DataTable,
                        this.Document.P3Table
                    ];
                }
            ...
            get: function () {
                if (this._shiftYearTables == null) {
                    this._shiftYearTables = [
                        ...
                        {
                            Table: this.Document.P3Table,
                            GenericFields: [BaseObasTableFields.YearDataField, BaseObasTableFields.UsdYearDataField]
                        }
                    ];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "DeleteYearTables", {
            get: function () {
                if (this._deleteYearTables == null) {
                    this._deleteYearTables = [this.Document.P2DataTable];
                }
    ...
    F01285.UpdateRules = UpdateRules;
})(F01285 || (F01285 = {}));
