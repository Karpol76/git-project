...
(function (F08500) {
    var FDocument = (function (_super) {
        ...
        function FDocument(id, version, oldVersion) {
            ...
            _this._p1Table = null;
            _this._tableRules = new F08500.TableRules(_this);
            _this._interfaceRules = new F08500.InterfaceRules(_this);
            _this._updateRules = new F08500.UpdateRules(_this);
            _this._exportRules = new F08500.ExportRules(_this);
            return _this;
        }
        ...
        Object.defineProperty(FDocument.prototype, "P1Table", {
            get: function () {
                if (this._p1Table == null) {
                    this._p1Table = new F08500.P1Table("F08_500_R1", this.P1TotalTable);
                }
        ...
        Object.defineProperty(FDocument.prototype, "P1TotalTable", {
            get: function () {
                if (this._p1TotalTable == null) {
                    this._p1TotalTable = new F08500.P1TotalTable("F08_500_R1_TopSum_V2", this);
                }
        ...
        Object.defineProperty(FDocument.prototype, "P1Sheet", {
            get: function () {
                if (this._p1Sheet == null) {
                    this._p1Sheet = new F08500.P1Sheet("SHT_F08_500_R1", this);
                }
        ...
        Object.defineProperty(FDocument.prototype, "ImportRules", {
            get: function () {
                if (this._importRules == null) {
                    this._importRules = new F08500.ImportRules(this);
                }
