...
(function (F05305) {
        ...
        Object.defineProperty(UpdateRules.prototype, "RecalcedDataTables", {
            get: function () {
                if (this._recalcedDataTables == null) {
                    this._recalcedDataTables = [this.Document.SubjectsDataTable, this.Document.SubvensionsDataTable,
                        this.Document.CoefficientsDataTable];
                }
                ...
                if (this._shiftYearTables == null) {
                    this._shiftYearTables = [
                        ...
                        },
                        {
                            ...
                            GenericFields: this.Document.SubjectsDataTable.ResetDataFields()
                        }
                    ];
                }
            ...
            get: function () {
                if (this._copyDataTables == null) {
                    this._copyDataTables = [
                        this.Document.P1TotalTable, this.Document.SubjectsDataTable, this.Document.SubvensionsDataTable,
                        this.Document.CoefficientsDataTable
                    ];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "DeleteYearTables", {
            get: function () {
                if (this._deleteYearTables == null) {
                    this._deleteYearTables = [this.Document.SubvensionsDataTable, this.Document.CoefficientsDataTable];
                }
    ...
    F05305.UpdateRules = UpdateRules;
})(F05305 || (F05305 = {}));
