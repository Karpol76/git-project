...
(function (F05304) {
        ...
        Object.defineProperty(UpdateRules.prototype, "ResetDataTables", {
            get: function () {
                if (this._resetDataTables == null) {
                    this._resetDataTables = [this.Document.CoefsTopDataTable];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "RecalcedDataTables", {
            get: function () {
                if (this._recalcedDataTables == null) {
                    this._recalcedDataTables = [this.Document.CoefsDataTable];
                }
            ...
            get: function () {
                if (this._shiftYearTables == null) {
                    this._shiftYearTables = [
                        ...
                        {
                            Table: this.Document.CoefsTopDataTable,
                            GenericFields: [BaseObasTableFields.YearDataField, this.Document.CoefsTopDataTable.TotalCoef]
                        }
                    ];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "CopyDataTables", {
            get: function () {
                if (this._copyDataTables == null) {
                    this._copyDataTables = [this.Document.P1TotalTable, this.Document.CoefsTopDataTable, this.Document.CoefsDataTable];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "DeleteYearTables", {
            get: function () {
                if (this._deleteYearTables == null) {
                    this._deleteYearTables = [this.Document.CoefsDataTable];
                }
    ...
    F05304.UpdateRules = UpdateRules;
})(F05304 || (F05304 = {}));
