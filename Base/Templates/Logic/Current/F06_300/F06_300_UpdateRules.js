...
(function (F06300) {
        ...
        Object.defineProperty(UpdateRules.prototype, "RecalcedDataTables", {
            get: function () {
                if (this._recalcedDataTables == null) {
                    this._recalcedDataTables = [this.Document.P2ServiceWorkIndicatorTable,
                        this.Document.P3SubsidieNameTable];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "CopyDataTables", {
            get: function () {
                if (this._copyDataTables == null) {
                    this._copyDataTables = [this.Document.P2ServiceWorkIndicatorTable,
                        this.Document.P3SubsidieNameTable];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "DeleteYearTables", {
            get: function () {
                if (this._deleteYearTables == null) {
                    this._deleteYearTables = [this.Document.P2ServiceWorkIndicatorTable,
                        this.Document.P3SubsidieNameTable];
                }
    ...
    F06300.UpdateRules = UpdateRules;
})(F06300 || (F06300 = {}));
