...
(function (F08810) {
            ...
            get: function () {
                if (this._resetDataTables == null) {
                    this._resetDataTables = [
                        this.Document.TableP1TopSum,
                        this.Document.TableP2,
        ...
        Object.defineProperty(UpdateRules.prototype, "RecalcedDataTables", {
            get: function () {
                if (this._recalcedDataTables == null) {
                    this._recalcedDataTables = [this.Document.TableP2Sp1, this.Document.TableP3Sp1];
                }
            ...
            get: function () {
                if (this._shiftYearTables == null) {
                    this._shiftYearTables = [
                        {
                            Table: this.Document.TableP1TopSum,
                            GenericFields: [BaseObasTableFields.YearDataField]
                        },
                        {
                            Table: this.Document.TableP2,
                            GenericFields: [BaseObasTableFields.YearDataField]
                        },
                        {
        ...
        Object.defineProperty(UpdateRules.prototype, "CopyDataTables", {
            get: function () {
                if (this._copyDataTables == null) {
                    this._copyDataTables = [this.Document.TableP2Sp1, this.Document.TableP3Sp1];
                }
        ...
        Object.defineProperty(UpdateRules.prototype, "DeleteYearTables", {
            get: function () {
                if (this._deleteYearTables == null) {
                    this._deleteYearTables = [this.Document.TableP2Sp1, this.Document.TableP3Sp1];
                }
    ...
    F08810.UpdateRules = UpdateRules;
})(F08810 || (F08810 = {}));
